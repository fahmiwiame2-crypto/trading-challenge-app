      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 animate-slide-up" style={{ animationDelay: '0.1s' }}>
            Join the next generation prop firm combining AI signals, real-time market data,
            and professional education. Pass the challenge, get funded, and trade with our capital.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto animate-fade-in" style={{ animationDelay: '0.3s' }}>
            {[
              ...
              <div key={index} className="glass-glow p-4 text-center">
        ...
        <div className="absolute left-10 top-1/3 hidden lg:block animate-float">
          <div className="glass-glow p-4 flex items-center gap-3">
